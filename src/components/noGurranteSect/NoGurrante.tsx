        ...
        <PxWrapper>
            <div className="md:grid grid-cols-12 flex flex-col-reverse">
                <div className="col-span-7 text-left">
                    <h2 className='text-4xl mb-10 bg-gradient-to-r from-blue-600 to-blue-900 text-transparent bg-clip-text'>No guarantees, but there are proactive steps you can take to significantly enhance your chances of success.</h2>
